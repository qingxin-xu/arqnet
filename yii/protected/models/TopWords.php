 ...
 *
 * The followings are the available columns in table 'top_words':
 * @property integer $top_words_id
 ...
 */
class TopWords extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('top_words_id, user_id, ae_response_id, ae_rank, ae_value, score, count', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('top_words_id',$this->top_words_id);
	 ...
	 * @return TopWords the static model class
	 */
