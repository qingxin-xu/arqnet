...
class QuestionCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('question_category_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('question_category_id, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('question_category_id',$this->question_category_id);
