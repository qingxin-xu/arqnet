...
<head>
	...
	<meta name="description" content="ArQ Admin Panel" />
	<meta name="author" content="" />
	
	<title>ArQnet Recent Journal Entries</title>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<strong>My Journals</strong>
								...
								<a style="float:right; width:20%;" href="journal.php" class="btn btn-success btn-icon btn-block">
			Compose Journal
...
<div class="row">
	...
	<div class="col-md-9 tocify-content">
		...
		<h2>Securing material goodness</h2>
		...
		<h2>﻿Whatever ladyship disposed</h2>
		...
		<h2>Mistaken kindness me feelings</h2>
