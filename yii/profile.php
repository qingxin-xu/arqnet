	...
	<div class="col-md-3 col-sm-8 clearfix">
		...
		<div class="col-md-3 col-sm-4 clearfix addG-progresswrap">
			...
			<div class="progress addG-progress">
				<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="background-color: #469c07;;width: 80%"></div>
		</div>
		</div>
